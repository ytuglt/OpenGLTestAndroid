...
#define NATIVE_RENDER_CLASS_NAME "com/example/coordsystemdemo/MyNativeRender"
#define NATIVE_BG_RENDER_CLASS_NAME "com/example/coordsystemdemo/egl/NativeEglRender"
