...
void OpenGLSample::LoadImage(NativeImage *pImage) {
    if (pImage)
    {
...
void OpenGLSample::LoadMultiImageWithIndex(int index, NativeImage *pImage)
{
...
void OpenGLSample::Init() {
    ...
    {
        LOGE("ParticlesSample::Init create program fail");
        return;
    }
...
void OpenGLSample::GenerateNewParticle(Particle &particle) {
    particle.life = 5.0f;
...
void OpenGLSample::Draw(int screenW, int screenH) {
    LOGI("ParticlesSample::Draw()");
...
void OpenGLSample::UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float ratio) {
    LOGI("ParticlesSample::UpdateMVPMatrix angleX = %d, angleY = %d, ratio = %f", angleX,
            angleY, ratio);
    angleX = angleX % 360;
    angleY = angleY % 360;
...
int OpenGLSample::UpdateParticles() {
...
int OpenGLSample::FindUnusedParticle() {
...
{
    LOGI("OpenGLSample::UpdateMatrix angleX = %d, angleY = %d, ratio = %f", angleXRotate,
            angleYRotate, ratio);
