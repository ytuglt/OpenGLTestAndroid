...
#define NATIVE_RENDER_CLASS_NAME "com/example/stenciltesting/MyNativeRender"
#define NATIVE_BG_RENDER_CLASS_NAME "com/example/stenciltesting/egl/NativeEglRender"
