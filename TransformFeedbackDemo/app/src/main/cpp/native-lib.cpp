...
#define NATIVE_RENDER_CLASS_NAME "com/example/transformfeedbackdemo/MyNativeRender"
#define NATIVE_BG_RENDER_CLASS_NAME "com/example/transformfeedbackdemo/egl/NativeEglRender"
